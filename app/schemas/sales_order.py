...
class SalesOrderCreate(BaseModel):
    customer_id: int = Field(..., ge=1, description="Contact ID of the customer")
    order_date: Optional[PyDate] = Field(None, description="Order date (defaults to today)")
    lines: List[SalesOrderLineCreate] = Field(..., min_length=1, description="Order lines (at least 1 required)")
